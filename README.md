...
>11/05 強度な隠蔽時でのマスクの失敗による前景深度の抽出の対策として、異常判断機構導入
>それにより各評価指標の向上が HOTA +1.2 → +2.4% AssA +1.6 → +3.5% IDF1 +1.5 → +3.6%に増加
...
| 提案手法(ds)        | 64.521 | 50.804 | 66.417 | 1399  |
...
| 提案手法(ds)        | 63.09  | 63.38  | 78.13  | 1953  |
